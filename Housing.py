...
print(tabulate(housing.head()))
print(tabulate(housing.info()))
print(housing["ocean_proximity"]. value_counts())
print(tabulate(housing.describe()))
...
train_set, test_set = split_train_test_by_id(housingWithId, .2, "index")

housingWithId["id"] = housing["longitude"] * 1000 + housing["latitude"]
train_set, test_set = split_train_test_by_id(housingWithId, 0.2, "id")
